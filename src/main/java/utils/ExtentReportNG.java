...
public class ExtentReportNG {
	...
	public static ExtentReports getReportObject() {
		...
		String path = System.getProperty("user.dir") + "//reports//bstackdemo_ExtentReport_"+timestamp+".html";
		ExtentSparkReporter reporter = new ExtentSparkReporter(path); // create object(reporter) for ExtentSparkReporter

		reporter.config().setReportName("bstackdemo Automation Test Results"); // this will create the report name
		reporter.config().setDocumentTitle("Test Results | Ecommerce_bstackdemo "); // this will set the title in web browser window
		...
		extent.setSystemInfo("Project Name", "Ecommerce_bstackdemo");
